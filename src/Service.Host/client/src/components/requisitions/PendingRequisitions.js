...
function PendingRequisitions() {
    ...
    const reqRows = () => {
        return filteredReqs(result).map(r => ({
            ...r,
            id: r.reqNumber,
            ...
            <Grid container spacing={3}>
                ...
                <Grid size={3}>
                    <Search
                        ...
                        resultsInModal
                        resultLimit={100}
                        helperText={filters.departmentName ? filters.departmentName : "Enter a search term and press enter to look up departments"}
                ...
                <Grid size={3}>
                    <Search
                        ...
                        resultsInModal
                        resultLimit={100}
                        helperText={filters.employeeName ? filters.employeeName : "Enter a search term and press enter to look up employees"}
