        ...
        private List<CalculationValueModel> SetModelRows(IEnumerable<GoodsInLogEntry> goodsInLogEntries)
        {
            ...
            foreach (var goodsInLogEntry in goodsInLogEntries)
            {
                ...
                values.Add(
                    ...
                    {
                        RowId = rowId,
                        TextDisplay = goodsInLogEntry.BookInRef.ToString(),
                        ColumnId = "BookInRef"
                    });
                values.Add(
                    new CalculationValueModel
                    {
                        RowId = rowId,
                        TextDisplay = goodsInLogEntry.DateCreated.ToString("dd/MM/yyyy"),
                ...
                values.Add(
                    ...
                    {
                        RowId = rowId,
                        TextDisplay = goodsInLogEntry.TransactionType,
                        ColumnId = "Type"
                    });
                values.Add(
                    new CalculationValueModel
                    {
                        RowId = rowId,
                        TextDisplay = goodsInLogEntry?.CreatedBy?.Name,
                        ColumnId = "CreatedBy"
                    });
                values.Add(
                    new CalculationValueModel
                    {
                        RowId = rowId,
                        TextDisplay = goodsInLogEntry.OrderNumber.ToString(),
                ...
                values.Add(
                    ...
                    {
                        RowId = rowId,
                        TextDisplay = goodsInLogEntry.OrderLine.ToString(),
                        ColumnId = "OrderLine"
                    });
                values.Add(
                    new CalculationValueModel
                    {
                        RowId = rowId,
                        TextDisplay = goodsInLogEntry.Quantity.ToString(),
                        ColumnId = "Quantity"
                    });
                values.Add(
                    new CalculationValueModel
                    {
                        RowId = rowId,
                        TextDisplay = goodsInLogEntry.StorageType,
