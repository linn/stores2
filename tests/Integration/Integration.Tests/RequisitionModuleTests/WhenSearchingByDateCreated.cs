namespace Linn.Stores2.Integration.Tests.RequisitionModuleTests
{
    ...
    public class WhenSearchingByDateCreated : ContextBase
    {
        ...
        public void SetUp()
        {
            ...
            var startDate = HttpUtility.UrlEncode(DateTime.Now.AddDays(-12).Date.ToString("o"));
            var endDate = HttpUtility.UrlEncode(DateTime.Now.AddDays(12).ToString("o"));

            this.Response = this.Client.Get(
                $"/requisitions?startDate={startDate}&endDate={endDate}",
                with =>
                    {
        ...
        public void ShouldOnlyReturnOneMatchingResult()
        {
            ...
            resource.Should().Contain(a => a.Comments == "Emp 123 req");
            resource.Should().Contain(a => a.Comments == "Emp 456 req");
        }
    }
}
