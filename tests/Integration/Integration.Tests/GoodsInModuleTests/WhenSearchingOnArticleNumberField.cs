namespace Linn.Stores2.Integration.Tests.GoodsInModuleTests
{
    ...
    public class WhenSearchingOnArticleNumberField : ContextBase
    {
        ...
        public void SetUp()
        {
            ...
            this.Response = this.Client.Get(
                "/stores2/goods-in/log?articleNumber=TEST",
                with =>
                {
        ...
        public void ShouldReturnNoResults()
        {
            ...
            resource.ElementAt(0).ArticleNumber.Should().Be("TEST PART/X/2");
            resource.ElementAt(1).ArticleNumber.Should().Be("TEST PART/X/1");
        }
    }
}
