namespace Linn.Stores2.Integration.Tests.GoodsInModuleTests
{
    ...
    public class WhenSearchingBetweenTwoDates : ContextBase
    {
        ...
        public void SetUp()
        {
            ...
            this.Response = this.Client.Get(
                $"/stores2/goods-in/log?fromDate={DateTime.Today.AddDays(-5)}?toDate={DateTime.Today}",
                with =>
                    {
        ...
        public void ShouldReturnNoResults()
        {
            ...
            resource.SingleOrDefault().Id.Should().Be(146);
        }
    }
}
