namespace Linn.Stores2.Integration.Tests.GoodsInModuleTests
{
    ...
    public class WhenSearchingAndSpecifyingCreatedBy : ContextBase
    {
        ...
        public void SetUp()
        {
            ...
            this.Response = this.Client.Get(
                "/stores2/goods-in/log?createdBy=33156",
                with =>
                    {
        ...
        public void ShouldReturnNoResults()
        {
            ...
            resource.SingleOrDefault().ReqNumber.Should().Be(1556);
            resource.SingleOrDefault().CreatedBy.Should().Be(33156);
        }
    }
}
