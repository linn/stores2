namespace Linn.Stores2.Integration.Tests.GoodsInModuleTests
{
    ...
    public class WhenSearchingWithNoParams : ContextBase
    {
        private GoodsInLogEntry firstLogEntry;

        private GoodsInLogEntry secondLogEntry;

        private GoodsInLogEntry thirdLogEntry;
        ...
        public void SetUp()
        {
            ...
            this.thirdLogEntry = new GoodsInLogEntry
                                      {
                                          ArticleNumber = "SECOND TEST PART/X/1",
                                          BookInRef = 543536,
                                          DateCreated = DateTime.Today.AddDays(-100), //should not return
                                          Comments = "Pull push",
                                          CreatedBy = 33156,
                                          DemLocation = "R4/2/4",
                                          ErrorMessage = string.Empty,
        ...
        public void ShouldReturnNoResults()
        {
            ...
            resource.FirstOrDefault().ReqNumber.Should().Be(1556);
        }
    }
}
