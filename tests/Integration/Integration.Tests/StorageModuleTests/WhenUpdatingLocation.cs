namespace Linn.Stores2.Integration.Tests.StorageModuleTests
{
    ...
    public class WhenUpdatingLocation : ContextBase
    {
        ...
        public void SetUp()
        {
            ...
            this.storageLocation = new StorageLocation(1, "E-FA-TEST", "TOAST DESCRIPTION", this.eaglesham, factoryArea,
                this.linn, "Y", "Y", "Y", "A", "A", null, null);
        ...
        {
            this.DbContext.StorageLocations.FirstOrDefault(x => x.LocationId == this.storageLocation.LocationId)
