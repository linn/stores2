namespace Linn.Stores2.Domain.LinnApps.Tests.RequisitionManagerTests
{
    ...
    public class WhenValidatingLdreqClosedNominal : ContextBase
    {
        ...
        public void SetUp()
        {
            ...
            this.NominalRepository.FindByIdAsync("2963")
                .Returns(new Nominal("2963", "DESC") { DateClosed = DateTime.Now.AddDays(-10) });
        ...
        {
            await this.action.Should().ThrowAsync<CreateRequisitionException>().WithMessage($"Nominal 2963 was closed on {DateTime.Now.AddDays(-10):dd MMM yyyy}");
        }
    }
}
