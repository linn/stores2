    ...
    public class WhenValidatingAuditAndLineMoveHasBothFromAndTo : ContextBase
    {
        ...
        public void SetUp()
        {
            ...
            this.StockService.ValidStockLocation(null, 123, "PART", 1, null, "LINN")
                .Returns(new ProcessResult(true, "got tons of this junk"));
        ...
        {
            await this.action.Should().ThrowAsync<InsertReqOntosException>().WithMessage("STADI transaction cannot specify onto location or pallet");
        }
    }
}
