namespace Linn.Stores2.Domain.LinnApps.Tests.RequisitionManagerTests
{
    ...
    public class WhenUnpickingReqMoveAndAlreadyCancelled : ContextBase
    {
        ...
        public void SetUp()
        {
            ...
            line.Cancel(7004, "Reason", new DateTime(2025, 1, 1));
        ...
        public async Task ShouldThrow()
        {
            await this.action.Should().ThrowAsync<RequisitionException>()
                .WithMessage("Line 1 on Req 123 is already cancelled"); ;
        }
    }
}
