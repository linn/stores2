namespace Linn.Stores2.Domain.LinnApps.Tests.RequisitionManagerTests
{
    ...
    public class WhenUnpickingReqMoveAndNoStockLocator : ContextBase
    {
        ...
        public void SetUp()
        {
            ...
            line.Moves.Add(new ReqMove(1, 1, 1, 1, null, 100, null, "LINN", "STORES", "FREE", null));
        ...
        public async Task ShouldThrow()
        {
            await this.action.Should().ThrowAsync<RequisitionException>()
                .WithMessage("Move 1 of Line 1 on Req 123 cannot be unpicked"); ;
        }
    }
}
