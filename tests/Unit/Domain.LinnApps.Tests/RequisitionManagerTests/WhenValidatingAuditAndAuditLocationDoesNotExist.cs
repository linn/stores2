namespace Linn.Stores2.Domain.LinnApps.Tests.RequisitionManagerTests
{
    ...
    public class WhenValidatingAuditAndAuditLocationDoesNotExist : ContextBase
    {
        ...
        {
            await this.action.Should().ThrowAsync<CreateRequisitionException>().WithMessage("Audit Location P123456 is not valid.");
        }
    }
}
