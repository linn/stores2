namespace Linn.Stores2.Domain.LinnApps.Tests.RequisitionManagerTests
{
    ...
    public class WhenValidatingAndPartSourceIsPurchaseOrderButOrderNonExisting : ContextBase
    {
        ...
        {
            await this.act.Should().ThrowAsync<CreateRequisitionException>().WithMessage("PO 1234567 does not exist!");
        }
    }
}
