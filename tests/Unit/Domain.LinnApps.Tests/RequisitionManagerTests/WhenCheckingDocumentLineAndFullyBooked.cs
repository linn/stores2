    ...
    public class WhenCheckingDocumentLineAndFullyBooked : ContextBase
    {
        ...
        public void SetUp()
        {
            ...
            var function = new StoresFunction
                { FunctionCode = "CUSTRET", Description = "RETURN GOODS FROM CUSTOMER TO STOCK/INSPECTION" };

            var requisitions = new List<RequisitionHeader>()
            {
                new RequisitionHeader(emp, function, null, 1, "C", null, null, null, null, null, null, null, null, null,
                    null, null, part, 6, 1),
                new RequisitionHeader(emp, function, null, 1, "C", null, null, null, null, null, null, null, null, null,
                    null, null, part, 3, 1)
            };

            var header = new RequisitionHeader(emp, function, null, 1, "C", null, null, null, null, null, null, null,
                null, null,
                null, null, part, null, 1);

            var document = new DocumentResult("C", 1, 1, 9, part.PartNumber);

            this.ReqRepository.FilterByAsync(Arg.Any<Expression<Func<RequisitionHeader, bool>>>()).Returns(requisitions);
        ...
        public async Task ShouldThrow()
        {
            await this.action.Should().ThrowAsync<DocumentException>()
                .WithMessage("Line is already fully booked");
        }
    }
}
