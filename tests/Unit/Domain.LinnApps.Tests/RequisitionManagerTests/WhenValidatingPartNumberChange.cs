namespace Linn.Stores2.Domain.LinnApps.Tests.RequisitionManagerTests
{
    ...
    public class WhenValidatingPartNumberChange : ContextBase
    {
        ...
        public async Task SetUp()
        {
            ...
            this.PartRepository.FindByIdAsync("ADIKT")
                .Returns(new Part { PartNumber = "ADIKT", ProductAnalysisCode = "ADIKT" });
            this.PartRepository.FindByIdAsync("ADIKT/X")
                .Returns(new Part { PartNumber = "ADIKT/X", ProductAnalysisCode = "ADIKT" });
