namespace Linn.Stores2.Domain.LinnApps.Tests.GoodsInLogTests
{
    ...
    public class WhenGettingReport : ContextBase
    {
        ...
        public void ShouldReturnReport()
        {
            ...
            this.result.GetGridTextValue(0, 9).Should().Be("6789");
            this.result.GetGridTextValue(0, 10).Should().Be("123456");
            this.result.GetGridTextValue(0, 11).Should().Be("PART PARCEL");
            this.result.GetGridTextValue(0, 12).Should().Be("161");
            this.result.GetGridTextValue(0, 13).Should().Be("1");
            this.result.GetGridTextValue(0, 14).Should().Be("4321");
            this.result.GetGridTextValue(0, 15).Should().Be("RSN");
            this.result.GetGridTextValue(0, 16).Should().Be("Log C");
            this.result.GetGridTextValue(0, 17).Should().Be("S");
            this.result.GetGridTextValue(0, 18).Should().Be("LC2016");
