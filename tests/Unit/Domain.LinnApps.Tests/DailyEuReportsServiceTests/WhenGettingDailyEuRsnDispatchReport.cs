namespace Linn.Stores2.Domain.LinnApps.Tests.DailyEuReportsServiceTests
{
    ...
    public class WhenGettingDailyEuRsnDispatchReport : ContextBase
    {
        ...
        {
            var values = new List<DailyEuRsnDispatch>
                                {
            ...
            this.result = await this.Sut.GetDailyEuRsnDispatchReport(1.December(2025), 20.December(2025));
        }
        ...
        public void ShouldReturnSummaryReport()
        {
            ...
            summary.GetGridTextValue(0, 2).Should().Be("Article 1 Description");
            ...
            summary.GetGridValue(0, 8).Should().Be(0);
            summary.GetGridValue(0, 9).Should().Be(56.78m);
            summary.GetGridValue(0, 10).Should().Be(45.5m);
            summary.GetGridValue(0, 11).Should().Be(50m);
            summary.GetGridTextValue(0, 12).Should().Be("D.D.P.");
            summary.GetGridTextValue(0, 13).Should().Be("123");
            summary.GetGridTextValue(0, 14).Should().Be("EUR");
            summary.GetGridValue(0, 15).Should().Be(1m);
            summary.GetGridValue(0, 16).Should().Be(56.78m);
            summary.GetGridValue(0, 17).Should().Be(0);
            summary.GetGridValue(0, 18).Should().Be(56.78m);
            summary.GetGridTextValue(0, 19).Should().Be("1234");
            summary.GetGridTextValue(0, 20).Should().Be("08-Dec-2025");
            ...
            summary.GetGridValue(1, 8).Should().Be(0);
            summary.GetGridTextValue(1, 14).Should().Be("EUR");
            summary.GetGridValue(1, 16).Should().Be(10m);
            ...
            summary.GetGridValue(2, 18).Should().Be(739.98m);

            summary.GetGridTextValue(3, 0).Should().Be("4");
            summary.GetGridValue(3, 8).Should().Be(150m);
            summary.GetGridValue(3, 9).Should().Be(350m);
            summary.GetGridValue(3, 17).Should().Be(15m);
            summary.GetGridValue(3, 18).Should().Be(35m);
        }
    }
}
