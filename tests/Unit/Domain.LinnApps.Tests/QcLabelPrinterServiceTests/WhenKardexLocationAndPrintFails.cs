namespace Linn.Stores2.Domain.LinnApps.Tests.QcLabelPrinterServiceTests
{
    ...
    public class WhenKardexLocationAndPrintFails : ContextBase
    {
        ...
        public async Task SetUp()
        {
            ...
            this.LabelPrinter.PrintLabelsAsync(
                ...
                .Returns((false, "Label Printing Failed?!? Never"));
        ...
        public void ShouldReturnFail()
        {
            ...
            this.result.Message.Should().Be("Label Printing Failed?!? Never");
        }
    }
}
